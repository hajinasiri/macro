...
var randtoken = require('rand-token');
 // nodemailer = require('nodemailer')
  //async = require('async');
 var sendgrid  = require('sendgrid')('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'); 
...
module.exports = function(mongoose) {
  ...
  var emailOptions = new sendgrid.Email(options.confirmMailOptions);
  ...
  var configure = function(optionsToConfigure, callback) {
    ...
    emailOptions = new sendgrid.Email(options.confirmMailOptions);
     var err;
