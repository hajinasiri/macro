...
$(document).ready(function() {
    ...
    if (isMobile.any === false) { 
        ...
        /* Animate elements in #pics (homepage) */
        $('#pics .intro .title').css('opacity', 0).one('inview', function(isInView) {
            if (isInView) {$(this).addClass('animated fadeInLeft delayp1');}
        });
        $('#pics .intro .summary').css('opacity', 0).one('inview', function(isInView) {
            if (isInView) {$(this).addClass('animated fadeInRight delayp3');}
        });
