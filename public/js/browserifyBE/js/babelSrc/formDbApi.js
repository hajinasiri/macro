/**
 * formDbApi.js api for the form database. Created Aug. 2017, Larry A. Maddocks
 * ****** Make sure this is hooked up before you use it. I don't know if this will ever be used.
 **/
/* global $, 
 ...
 $("#mapDbForm").submit((event) => {
  ...
  $.post("/maps/updateRow", data, (result) => {
   if (result.status === "success") {
    alert("Update was successful. To see the effect of your changes, refresh the screen.");
    console.log("Map db updated: ");
   }
   else {
    alert("Update was unsuccessful: " + result.msg);
   }
