...
function populateInfoPane(unoGIdObject) {
  ...
  if (unoGIdObject.shouldPopulateInfoPane === "1") {
    ...
    if (/\+\+\+&unoInfo/.test(longDescription)) {
      var re = /\+\+\+&unoInfo=(.+)/i; //regular expression: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp
      var found = longDescription.match(re); //grab the uno id. found[1] contains the uno id
      ...
      var re = /\+\+\+&fileInfo=(.+)/i; //regular expression: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp
      ...
      var re = /\+\+\+&formInfo=(.+)/i; //regular expression: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp
      var found = longDescription.match(re); //grab the file name. found[1] contains the file name
