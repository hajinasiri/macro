...
SvgPanZoom.prototype.publicZoomAtPoint = function(scale, point, absolute) {
  ...
  else if (Utils.getType(point) !== 'SVGPoint') {
...
//     y: viewportCTM.f
//   };
//   var xInterval = (point.x - currentPan.x) / 10;
//   var yInterval = (point.y - currentPan.y) / 10;
//   while (!(currentPan.x >= point.x) && !(currentPan.y >= point.y)) {
//     if (!(currentPan.x >= point.x)) {
//       this.realPan({
//         'x': (currentPan.x += xInterval)
//       });
//     }
//     if (!(currentPan.y >= point.y)) {
//       this.realPan({
//         'y': currentPan.y += yInterval
//       });
//     }
//   }
// };
...
// SvgPanZoom.prototype.pan = function(point) {
//   var viewportCTM = this.viewport.getCTM();
//   // point.x = viewportCTM.e - point.x;
//   // point.y = viewportCTM.f - point.y;
//   // viewportCTM.e = point.x
//   // viewportCTM.f = point.y
//   // this.viewport.setCTM(viewportCTM)
//   var that = this;
...
//     ,
//     animationStepTime = 1 // one frame per 30 ms
//     ,
...
//       this.realPan({
//         x: stepX * animationStep,
//         y: stepY * animationStep
//       });
//     }
//     else {
//       // Cancel interval
