...
BaseIdClass.prototype.single = function (event) {
  ...
  /* else if (event.ctrlKey == true) {
     ...
     **/
        ...
        var segmentName = wrapperObject.uno;
...
BaseIdClass.prototype.mClick = function (event) {
  ...
  if (event.altKey === true) {} else if (idiagramSvg.gClicked === "m" && wrapperObject.hasOwnProperty("uno")) {
...
BaseIdClass.prototype.setHoverOnOff = function () {
  ...
  if (this.alreadySetHoverOnOff === false) {
    ...
    if (this.onhover.length && this.onhover == "1") {
      // Stop tooltip from
